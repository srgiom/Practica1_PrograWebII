...
async function loadDefaultExport(resolvedPath, extension) {
    ...
    if (process.features.typescript && /\.[cm]?tsx?$/.test(extension)) {
        try {
            ...
            if (isESMError(e)) {
                ...
                try {
                    return (await import(__rewriteRelativeImportExtension((0, node_url_1.pathToFileURL)(resolvedPath).href))).default;
                }
                catch {
    ...
    try {
        await registerLoader(interpret_1.jsVariants[extension]);
    }
    catch (e) {
